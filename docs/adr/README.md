...
| [0009](0009-aeroporto-de-referencia-na-origem-e-paradas.md) | Aeroporto de Referência na Origem e nas Paradas para rotas planejadas | Accepted |
...
| [0016](0016-orcamento-sem-conversao-de-cambio.md) | Orçamento sem conversão de câmbio (subtotais por moeda) + boundary `budget` | Accepted |
| [0017](0017-notificacoes-persistidas-sem-barramento.md) | Notificações persistidas por destinatário, sem barramento de eventos | Accepted |
