...
Issues e PRDs deste repo vivem como issues do GitHub (`ThiagoPanini/travelmanager`). Use a CLI `gh` para todas as operações — ela infere o repo a partir do `git remote`.
